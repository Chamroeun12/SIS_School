...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <button type="button" class="btn1 bg-sis text-white float-sm-right" data-toggle="modal"
                        data-target="#modal-lg"><i class="fas fa-plus iconz"></i> បង្កើតថ្មី</button>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background-color:#152550; color:white;">
                            <h3 class="card-title">|បន្ថែមមុខវិជ្ជា</h3>
            ...
            <!-- Foreach Loop -->
            <div class="card">
                <div class="row p-4 ml-4 mr-4 mt-2">
                                ...
                                <div class="mr-3 dropup">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="update_subject.php?sub_id=<?= $row['SubID']; ?>"
                                            class="dropdown-item"><i class="fa fa-edit text-success"></i> កែប្រែ</a>
